...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>bdc9dee3-44ec-41d4-90e3-46ef401801ab</elementGuidId>
...
WS.verifyElementPropertyValue(response, '[5].postId', 1)
...
WS.verifyElementPropertyValue(response, '[6].postId', 1)
...
WS.verifyElementPropertyValue(response, '[7].postId', 1)
...
WS.verifyElementPropertyValue(response, '[8].postId', 1)
...
WS.verifyElementPropertyValue(response, '[9].postId', 1)
